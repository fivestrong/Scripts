...
DB_USERNAME="xxxxx"                  #mysql登录用户名
DB_PASSWORD="xxxxx"                  #mysql登录密码
...
scp ${BACKUP_FOLDER}.tar.bz2 root@127.0.0.1:/root/
